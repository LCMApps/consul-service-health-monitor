    ...
    firstResponseBody: [
        {
            "Checks": [
                ...
                },
                {
                    ...
                    "Node": "transcoder-1.priv",
                    "Notes": "",
                    "Output": `HTTP GET http://192.168.101.10:8080/transcoder/v1/service/status: 200 OK Output: {"data":${JSON.stringify(loadData1)}}`,
        ...
        },
        {
            "Checks": [
                ...
                },
                {
                    ...
                    "Node": "transcoder-2.priv",
                    "Notes": "",
                    "Output": `HTTP GET http://192.168.101.11:8080/transcoder/v1/service/status: 200 OK Output: {"data":${JSON.stringify(loadData1)}}`,
